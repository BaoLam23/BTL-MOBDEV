...
public class MyStore extends GameObject {
    ...
    public MyStore(float x, float y, Context context, MyBag bag, ArrayList<Structure> city, ArrayList<ArrayList<Integer>> area , long money) {
        super(x, y, context, R.drawable.store,2,height,width);
